...
require (
	...
	github.com/google/go-licenses v1.6.1-0.20230903011517-706b9c60edd4 // Pin non-release version until https://github.com/google/go-licenses/issues/235 is fixed
)
