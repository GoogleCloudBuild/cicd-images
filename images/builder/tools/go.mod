...
require (
	github.com/GoogleCloudPlatform/cloud-builders/gcs-fetcher v0.0.0-20240419200951-921a65a8d7df
	github.com/GoogleCloudPlatform/cloud-builders/gke-deploy v0.0.0-20240419200951-921a65a8d7df
