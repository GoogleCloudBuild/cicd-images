...
func TestPackagePythonArtifact(t *testing.T) {
	t.Run("successful with commands", func(t *testing.T) {
		...
		mockRunner.On("Run", command.VirtualEnvPython3, mock.AnythingOfType("[]string")).Return(nil)
		args := Arguments{
	...
	t.Run("failure with commands", func(t *testing.T) {
		mockRunner := new(command.MockCommandRunner)
		mockRunner.On("Run", command.VirtualEnvPython3, mock.AnythingOfType("[]string")).Return(errors.New("command failed"))
		args := Arguments{
			Command: []string{"test-command"},
		}
...
func TestExecute(t *testing.T) {
	t.Run("failed to create virtual environment", func(t *testing.T) {
		mockRunner := new(command.MockCommandRunner)
		mockRunner.On("Run", command.Python3, mock.AnythingOfType("[]string")).Return(errors.New("failed to create virtual environment"))
		mockClient := new(auth.MockHTTPClient)
	...
	t.Run("failed to install dependencies for package command", func(t *testing.T) {
		mockRunner := new(command.MockCommandRunner)
		mockRunner.On("Run", command.Python3, mock.AnythingOfType("[]string")).Return(nil)
		mockRunner.On("Run", command.VirtualEnvPip, mock.AnythingOfType("[]string")).Return(errors.New("failed to install dependencies for package command"))
		mockClient := new(auth.MockHTTPClient)
	...
	t.Run("failed to package python artifact", func(t *testing.T) {
		mockRunner := new(command.MockCommandRunner)
		mockRunner.On("Run", command.Python3, mock.AnythingOfType("[]string")).Return(nil)
		mockRunner.On("Run", command.VirtualEnvPip, mock.AnythingOfType("[]string")).Return(nil)
		mockRunner.On("Run", command.VirtualEnvPython3, mock.AnythingOfType("[]string")).Return(errors.New("failed to package python artifact"))
		mockClient := new(auth.MockHTTPClient)
